...
@Component({
  selector: 'app-header-leaderboard-admin',
  templateUrl: './header-leaderboard-admin.component.html',
  styleUrls: ['./header-leaderboard-admin.component.css']
})
export class HeaderLeaderboardAdminComponent implements OnInit {
  cliente = new Cliente();
  nome = ''
  saldo = 0;
  ...
  voltar(){
    this.router.navigateByUrl(`admin/${this.cliente.email}`);
  }
}
